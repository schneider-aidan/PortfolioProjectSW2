...
I decided to choose the rectangle component that I brainstormed in the previous assignment because of the fact that it was the
most refined and I felt that I could be the most creative with that design. I also thought that it had the most room to 
grow even after this assignment is complete due to geometry having a lot of applications especially relating to graphics, or just straight
up math related applications.
...
I think that it is hard to create a java file from scratch to implement the methods especially considering that many of the reference interfaces
like all of the secondary interfaces in the OSU CSE components are hidden from students.
