...
I feel as if there are a lot of details from class that don't really matter when designing your own
component and that there are also a lot of details that you have to figure out on your own
that we didn't learn in class. I think that this has made my understanding of software
development better than before by a decent amount compared to before.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

I think that it surfaced my gap in how interfaces are laid out specifically the syntax of them
as well as proving my idea that software development must be difficult false.

> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

Well it wasn't exactly something that I enjoyed much before but I actually found this
project to be quite fun and so it really opened my eyes as to the possibilities of what
you can represent with a component.
...
I think that at least one of the skills that I picked up is for sure the ability to
find creative solutions to the problems that I was running into. A specific example of this
was changing my representation of my rectangle from all four corner points to just
two in order to make things simpler.

> The follow-up question is: could you rephrase these skills you picked up
> as bullet points that you could put on a resume? Try it below.

-Adaptable to problems faced in work

> Next, how has working on this project affected your career trajectory?
> In other words, do you now hate the topic you picked? Or, are you even more
> interested in it? Both outcomes are valuable to your personal development.

I think this project has made me even more confused as to where I would like to end
up because it actually made me enjoy coding so now I am back to being stuck between
choosing a software job and a hardware based job. Maybe I will try to find some sort
of robotics job that integrates both software development and hardware.
...
I think that if I wanted to continue on this trajectory I should probably start to code
things more related to robotics, like mircrocontrollers, and I should probably find some mentor
in the ECE department that works with things like this. I could also continue to expand my software
development skills with something like a web development personal project(something I've been thinking
of doing for a while), and if this were the case I would probably talk to Jeremy about finding someone
who knows what they're doing in this area to be a mentor to me.
