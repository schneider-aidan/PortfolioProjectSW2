...
I have decided that I am going to make the user only enter two points in order to create a valid rectangle.
While still needing to check if the users' given points make a valid rectangle(not a line or not both on the same point or that they
even entered two points), it will make it much easier considering I won't have to check that all points make a line parallel to the
axes.
